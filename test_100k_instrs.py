#!/usr/bin/env python3
"""
Run 100K instructions and track when timer is armed.
"""
...
# Run 100K instructions (100 iterations * 1000 instrs per iteration)
print("Running 100K instructions...")
for iteration in range(100):
    ...
    if iteration % 10 == 0 and iteration > 0:
        print(f"  Progress: {instr_count:6d} instrs, PC=0x{pc:08x}, timer_irq={timer_irq_count}, total_irq={total_irq_count}")

print(f"\nDone! Final state: {instr_count} instrs, timer_irq={timer_irq_count}, total_irq={total_irq_count}, mtimecmp=0x{mtimecmp:016x}")