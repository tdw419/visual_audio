#!/usr/bin/env python3
"""
Quick boot test with limited iterations.
"""
...
for iteration in range(10):
    ...
    print(f"  Iter {iteration}: PC=0x{pc:08x}, running={running}, instr={instr_count}, timer_irq={timer_irq_count}, total_irq={total_irq_count}")
