#!/usr/bin/env python3
"""
Boot Ubuntu from MKV with extracted QEMU.

This is the self-hosting version of boot_ubuntu_from_mkv_streaming.py
that uses QEMU extracted from the MKV.
...
def boot_ubuntu_with_extracted_qemu():
    """Boot Ubuntu from MKV using extracted QEMU."""
    print("=" * 70)
    print("Boot Ubuntu from MKV with Extracted QEMU")
    print("=" * 70)
    ...
    # QEMU command with extracted QEMU
