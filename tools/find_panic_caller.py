...
def find_panic_caller():
    """Find where panic is called from."""
    print(f"\n{'='*70}")
    print("Finding panic caller")
    print(f"{'='*70}")
    ...
    # Watch for when we hit 0x80000ac0 (the infinite loop)
    for step in range(200000):
        ...
        if pc == 0x80000ac0:
            ra = (regs[1][1] << 32) | regs[1][0]
            print(f"\nHit panic loop at 0x80000ac0")
            print(f"Return address (ra) = 0x{ra:016x}")
