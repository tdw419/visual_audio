...
def trace_srliw_raw():
    ...
    # regs is at offset 8, each reg is 8 bytes
    regs_start = 8
    a6_offset = regs_start + 18 * 8  # regs[18]
    print(f"regs field starts at byte offset {regs_start}")
    print(f"regs[18] (a6) starts at byte offset {a6_offset}")
    ...
    for step in range(200000):
        ...
        if pc == 0x80001180:
            ...
            print(f"  Raw bytes at offset {a6_offset}:")
            raw_bytes = cpu_readback_bytes.tobytes()[a6_offset:a6_offset+8]
