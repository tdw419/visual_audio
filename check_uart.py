...
shader = (Path(__file__).parent / 'tools' / 'RISCV_CPU_MMU.wgsl').read_text()
...
from tools.riscv_gpu_cpu import make_cpu_state
...
print(f'PC: 0x{cpu_read["pc"][0] | (cpu_read["pc"][1] << 32):016x}')
print(f'Running: {cpu_read["running"]}')
