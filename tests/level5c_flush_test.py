#!/usr/bin/env python3
"""
Minimal sync flush test - use queue.submit([]) before read to ensure completion.
"""
...
def main():
    ...
    # CRITICAL: Flush to ensure GPU completion before reading
    print("Flushing GPU...")
    core.queue.submit([])
    ...
    if "Level 5c Complete." in uart:
        ...
        print("FAILED: Level 5c did not complete")
        print()
        print("UART output:")
        print(uart)
